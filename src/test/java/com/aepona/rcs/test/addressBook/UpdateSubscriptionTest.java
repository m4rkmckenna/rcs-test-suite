...
public class UpdateSubscriptionTest {
    ...
    private final Logger LOGGER = LoggerFactory.getLogger(UpdateSubscriptionTest.class);
        ...
        Response response =
                RestAssured.given()
                           ...
                           .body("abChangesSubscription.resourceURL", StringContains.containsString(cleanUserID),
                                 ...
                                 "abChangesSubscription.callbackReference.notifyURL", IsEqual.equalTo(callback),
    ...
    @Test
    public void updateSubscriptionForUser2() {
        String userID = user2;
    ...
    public void updateSubscriptionForUnsubscribedUser() {
        ...
        String clientCorrelator = Long.toString(System.currentTimeMillis());
        String callback = userThree.getCallbackURL();
        String requestData = requestDataClean(updateAddressBookRequestData, clientCorrelator, callback);
