...
public class RetrieveListTest {
    ...
    public void retrieveList() {
        ...
        Response response =
                RestAssured.given()
                           ...
                           .ifError()
                           .statusCode(200)
                           .body("fileTransferSubscriptionList.resourceURL", StringContains.containsString(cleanUserID))
                           .get(url);
    ...
    public void retrieveList3() {
        String userID = user1;
        int i = 1;
        unsubscribeFileTransferSubscriptions(userOne);
    ...
    private void unsubscribeFileTransferSubscriptions(final TestSubscriber testSubscriber) {
        String test = "Unsubscribe User " + testSubscriber + " from File Transfer";
        startTest(test);

        String url = testSubscriber.getFileTransferSubscriptionUrl();
        url = prepare(url);
