...
public class RetrieveIndividualTest {
    ...
    public void retrieveUser2SessionSubscription() {
        ...
        TestUtils.subscribeToSession(userTwo, sessionSubscriptionURL, sessionRequestData, apiVersion,
                                     applicationUsername, applicationPassword);
    ...
    public void retrieveUser1SessionSubscription() {
        ...
        TestUtils.startNotificationChannel(userOne, notificationChannelURL, apiVersion, validLongPoll,
                                           applicationUsername, applicationPassword);
        TestUtils.subscribeToSession(userOne, sessionSubscriptionURL, sessionRequestData, apiVersion,
                                     applicationUsername, applicationPassword);
